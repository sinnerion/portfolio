...
// Carousel
!function (d) {
  var itemClassName = "month",
      items = d.getElementsByClassName(itemClassName),
      totalItems = items.length,
      slide = 0,
      moving = true; // Set classes
  ...
  function setEventListeners() {
    var next = d.getElementsByClassName('month-carousel__arrow_next')[0],
        prev = d.getElementsByClassName('month-carousel__arrow_prev')[0];
